...
/**
 * @title Sales
 * Adapted from CryptoArteSales
 */
contract Sales is Ownable, Pausable, Destructible {
    ...
    * @param _nftAddress address for CryptoJourney non-fungible token contract
    */
    constructor(address _nftAddress) public {
        require(_nftAddress != address(0) && _nftAddress != address(this), "NFT address cannot be empty or this contract's address");
        nftAddress = ERC721(_nftAddress);
    }

    /**
    * @dev Purchase _tokenId
    * @param _tokenId uint256 token ID (place id)
    */
